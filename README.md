...
## Overview
LiteMamba-Seg is a lightweight polyp segmentation framework designed to balance segmentation accuracy and computational efficiency, with evaluation conducted under both in-domain and cross-dataset settings. The model is built on a U-Net-like encoder-decoder architecture with a ResNet34 backbone and selective Mamba-based contextual modeling.
...
@article{LiteMambaSeg,
  title={Efficient and real-time polyp segmentation: An empirical evaluation of lightweight Mamba integration strategies},
  author={...},
  journal={...},
  year={2026}
}
